...
class DataIngestion:
    ...
    def get_required_interval(self):
        ''' if days differenece is more than 7 days then download will be for a week, if difference is more than 30days then downlaoad 
            for a month, if difference is 365 days then download duration is for a year other cases as per start and end date '''
